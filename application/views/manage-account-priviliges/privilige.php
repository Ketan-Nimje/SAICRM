                                    ...
                                    <div class="row g-4 mb-0">
                                        ...
                                        <div class="col-sm">
                                            <div class="d-flex justify-content-sm-end">
                                                <button type="button" class="btn btn-label btn-rounded btn-sm btn-dark waves-effect waves-light"
data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line label-icon align-middle fs-16 me-2"></i> Add</button>
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- end card header -->
                ...
                <form class="needs-validation" novalidate>
                    <div class="modal-body">
                        ...
                        <div class="mb-3" id="modal-id" style="display: none;">
                            ...
                            <input type="text" id="id-field" class="form-control" placeholder="ID" required />
