                                                                ...
                                                                <div class="pull-left">   
                                                                   ...
                                                                   <label for="lan">UL</label></div><input class="form-control" id="total_lan" name="total_lan[]"  type="text" placeholder="Lan" value="0"> -->
                                                                    <select class="form-control" id="s_pc" name="s_pc[]">
                                                                        <option value="0">Dec Without Srv</option>
                                                                        <option value="1">Dec With Ser</option>
...
<script>
    ...
    $(document).on('keyup','#contact_person',function () { // search data by invoice or datewise

        var cont = $('#contact_person').val();
        
//        var fval = id + ' - ' + date;
//        tabs.columns(1).search(fval).draw();
        tabs.column(1).search(cont).draw();
    });
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 1) {
                        ...
                        $('#productdetail').DataTable().destroy();
                        var id = $("#hid").val();
                        var url = "<?php echo base_url() . $this->uri->segment(2) . 'get_client_all_product'; ?>";
                        $('#productdetailrow').show();
                        var tabs1 = $('#productdetail').DataTable({
                            "processing": true,
                            "serverSide": true,
