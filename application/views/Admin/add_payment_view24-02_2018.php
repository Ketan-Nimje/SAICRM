                                                                    ...
                                                                    <div class="optimize-spacing">
                                                                        ...
                                                                        <div class="bank-transfers clearfix">
                                                                            ...
                                                                            <div class="input-group three-parts">
                                                                                ...
                                                                                <input class="form-control" id="bank_amount" name="bank_amount" placeholder="Bank Amount" value="0" type="text">
                                                                            </div>
                                                                            </div> 
                                                                            <div class="two-parts">
                                                                            <div class="form-group online" style="display: none;">
                                                                            <div class="input-group">
                                                                                <input class="form-control" id="online_amount" name="online_amount" placeholder="Online Amount" value="0" type="text">
                                                                            </div>
                                                                            </div>
                                                                            <div class="form-group cash" style="display: none;">
                                                                            <div class="input-group">
                                                                                <input class="form-control" id="cash_amount" name="cash_amount" placeholder="Cash Amount" value="0" type="text">
                                                                            </div>
                                                                            </div>
                                                                            </div>
                                                                        </div>
