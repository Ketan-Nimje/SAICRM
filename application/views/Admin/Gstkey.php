...
<body class="fix-header">
                                ...
                                <div class="white-box">
                                        ...
                                        <div class="tab-content">
                                            <div id="home" class="tab-pane fade in active">    
                                                    <div class="panel">
                                                        <div class="panel-heading">Manage Gst Key</div>
                                            ...
                                            <div id="menu1" class="tab-pane fade">  
                                                    <div class="panel">
                                                      <div id="paneltitle" class="panel-heading">Add GSTkey</div> 
                                                      <div id="panelupdate" class="panel-heading">Update GSTkey</div> 
                                                    <form name="ff" class="form-horizontal" method="post"
                                                          action="<?php echo base_url() . 'Admin/' . $this->uri->segment(2) . '/addData'; ?>">       
                                                            <div class="form-group">
                                                                <label class="col-md-12">Year Name <span class="help"> E.g. "192-168-100-123"</span></label>
                                                                <div class="col-md-12">
                                                                <input  type="hidden" name="hid" id="hid" >
                                                                <input type="text" name="gstkey" id="gstkey" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col-sm-12">
    ...
    <script>
            ...
            var tabs = $('#product').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "<?php echo base_url() . 'Admin/Gstkey/GetData'; ?>",
            ...
            $('#product>tbody').on('click', '.status', function () {
                ...
                if (st != "A") {
                    var msg = "You won't be deactive this GstKey?";
                    var btn = 'Yes, De-active it!';
                    var title = "De-Activate";
                } else {
                    var msg = "You won't be active this GstKey?";
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data == 1) {
                                swal(
                                        'Successfully!',
                                        'Selected GstKey has been ' + title + '.',
                                        'success'
                                        )
                                tabs.draw();
                            }
            ...
            $('#product>tbody').on('click', '.delete', function () {
                ...
                swal({
                    title: 'Are you sure?',
                    text: "You won't be get this GstKey Again",
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data == 1) {
                                swal(
                                        'Successfully!',
                                        'Selected GstKey has been  Deleted.',
                                        'success'
                                        )
                                tabs.draw();
                            }
            ...
            $('#product>tbody').on('click', '.edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {                        
                        ...
                        $('#paneltitle').hide();
                        $('#panelupdate').show();
                        $('#gstkey').val(data.gstkey);
                        $('#hid').val(data.si_gstkey_id);
                        $('#btn_stm').val('update');
                        $('#tblhid').val(tbl);
                        $('#tblcntrl').val(cntrl);
                        $('#editmenu').modal('show');
