                                                    ...
                                                    <div class="col-sm-6 col-sm-12">
                                                        <div class="white-box bg-white-dark optimize-box m-b-0">
                                                            ...
                                                            <div class="no-bg-addon row optimize-spacing">
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    <select class="form-control" id="si_product_id"  required name="si_clients_details_id" required>
                                                                ...
                                                                <div class="form-group col-sm-12 checkbox checkbox-danger lan">
                                                                    ...
                                                                    <div class="col-sm-7 two-parts-inline-input"> 
                                                                    	<div class="form-group">
                                                                          <div id="label_lan" style="display:none">No. </div><input class="form-control" id="total_lan" name="total_lan[]"  type="text" placeholder="Lan" value="0" style="display:none">
                                                                          <input class="form-control" id="old_lan" name="old_lan"  type="hidden" placeholder="Lan" value="0">
                                                                          </div>
                                                                        	
                                                                        <div class="form-group">
                                                                          <div id="lable_lan_amout" style="display:none">Amt.</div><input class="form-control" id="total_lan_amout" name="total_lan_amout[]"  type="text" placeholder="Lan" value="0" style="display:none">
                                                                          </div>
                                                                          <div class="form-group">
                                                                          <div id="lable_lan_cost_amout" style="display:none">P Amt.</div><input class="form-control" id="total_lan_cost_amout" name="total_lan_cost_amount[]"  type="text" placeholder="Purchase Lan" value="0" style="display:none">
                                                                          </div>   
                                                                    </div>
                                                            ...
                                                            <div class="col-sm-6 col-sm-12 p-0">
                                                                <div class="white-box bg-white-dark optimize-box m-b-0 clearfix" style="padding: 0px 12px 5px;"> 
                                                                    <div class="optimize-spacing">
                                                                        ...
                                                                        </div> <div class="form-group checkbox checkbox-danger email-change p-l-0">
                                                                            <input id="paymentdue" name="paymentdue" value="1" type="checkbox">
                                                                            <label for="paymentdue"> Payment Due</label>
                                                                        </div>    
                                                                         <p class="text-muted paymentdue m-b-0 m-t-10">Deposit Bank</p>
    ...
    <div class="modal-dialog modal-xs">
        ...
        <form method="post" id="myform" action="<?php echo base_url("Admin/TransactionsDetail/AddTransDet");?>" >
            <div class="modal-content">
                ...
                <div class="modal-body clearfix"><div class="row">
        <div class="col-sm-12 col-sm-12">
            <div class="bg-white-dark clearfix"> 
...
<script>
        ...
        $.ajax({
                    ...
                    success: function (data) {                        
                       console.log(data);
                        ...
                        $('#si_product_id-edit').find('option').remove();
                        $('#si_product_id-edit').append($("<option></option>")
 ...
 // View Table In Tree Start
        ...
        $.ajax({
                ...
                success: function (data) {
                   // console.log(data);
                    ...
                    $('#amount').val(data[0].sale_amount);
					$('#costamount').val(data[0].sale_amount);
    ...
    function change_product_con() {
        ...
        if ($('#category_id').val() == "2" || $('#category_id').val() == "3"|| $('#category_id').val() == "4") {
            var id = $('#hid').val();
            $.ajax({
                type: 'post',
                data: {'id': id, 'tbl': tbl},
