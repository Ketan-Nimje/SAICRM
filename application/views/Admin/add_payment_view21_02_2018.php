                                                        ...
                                                        <div class="white-box bg-white-dark optimize-box m-b-0">
                                                            ...
                                                            <div class="no-bg-addon row optimize-spacing">
                                                                ...
                                                                <div class="form-group col-sm-12 checkbox checkbox-danger lan">
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                          <div id="label_lan" style="display:none">Number </div><input class="form-control" id="total_lan" name="total_lan[]"  type="text" placeholder="Lan" value="0" style="display:none">
                                                                        
                                                                          <div id="lable_lan_amout" style="display:none">Amount</div><input class="form-control" id="total_lan_amout" name="total_lan_amout[]"  type="text" placeholder="Lan" value="0" style="display:none">
                                                                    </div>
                                                                    ...
                                                                    <div class="optimize-spacing">
                                                                        ...
                                                                        <div class="bank-transfers clearfix">
                                                                            <div class="radio radio-primary">
                                                                                <input name="payment_type" id="Bank" required value="Bank" type="radio">
                                                                                <label for="Bank"> Bank </label>
                                                                            </div>
                                                                            <div class="radio radio-info">
                                                                                <input name="payment_type" id="Online" required value="Online" type="radio">
                                                                                <label for="Online"> Online </label>
                                                                            </div>
                                                                            <div class="radio radio-success">
                                                                                <input name="payment_type" id="Cash" required value="Cash" type="radio">
                                                                        ...
                                                                        <div class="form-group checkbox checkbox-danger email-change bill-pay">
                                                                            <input id="billpayment" name="isbill" type="checkbox">
...
<script>
 ...
 // View Table In Tree Start
    ...
    function get_product_det(){
        ...
        $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#last_renewal_date').val(data[0].renewal_date);
                    if(data[0].p_email!='')
    ...
    function change_product_con() {
        ...
        if ($('#category_id').val() == "2" ||$('#category_id').val() == "3") {
            var id = $('#hid').val();
            $.ajax({
                type: 'post',
                data: {'id': id, 'tbl': tbl},
