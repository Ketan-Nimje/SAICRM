            ...
            <div class="modal-content">
                ...
                <form data-modal="showModal" method="POST" action="<?= $_controller_path ?>add_update" class="needs-validation form-submit" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="l_name-field" class="form-label required">Product Name: </label>
                            <small>Ex: Genius</small>
                            <input type="text" name="l_name" id="l_name-field" class="form-control" placeholder="Enter Product Name" required />
                            <div class="invalid-feedback">
                                Please enter product name.
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="up_file-field" class="form-label">Link: </label>
                            <small>Ex: http://downloads1.saginfotech.com/Util/ODBC.zip</small>
                            <input type="url" name="up_file" id="up_file-field" class="form-control" placeholder="Enter Link" />
                            <div class="invalid-feedback">
                                Please enter link.
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="productid-field" class="form-label">For: </label>
                            <select class="form-control" name="productid" id="productid-field">
                                <?php
                                if (!empty($categories)) {
