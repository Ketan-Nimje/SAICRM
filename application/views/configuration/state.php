            ...
            <div class="modal-content">
                ...
                <form data-modal="showModal" method="POST" action="<?= $_controller_path ?>add_update" class="needs-validation form-submit" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="name-field" class="form-label required">State Name: </label>
                            <small>Ex: Gujarat</small>
                            <input type="text" name="name" id="name-field" class="form-control" placeholder="Enter State Name" required />
