            ...
            <div class="modal-content">
                ...
                <form data-modal="showModal" method="POST" action="<?= $_controller_path ?>add_update" class="needs-validation form-submit" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="year-name-field" class="form-label required">GST Key: </label>
                            <small>Ex: 192-168-100-123</small>
                            <input type="text" name="gstkey" id="year-name-field" class="form-control" placeholder="Enter GST Key" required />
                            <div class="invalid-feedback">
                                Please enter gst key.
                            </div>
                        </div>
                    </div>
