...
$route["{$folder}client-master/add_update_product"] = "{$folder}ClientMaster/add_update_product";
$route["{$folder}client-master/edit/(:num)"] = "{$folder}ClientMaster/edit/$1";
$route["{$folder}client-master/edit-product/(:num)"] = "{$folder}ClientMaster/edit_product/$1";
